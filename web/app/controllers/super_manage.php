...
EOD;
			...
			case 'ignore':
                DB::query("delete from user_pending where username = '$username'");
			case 'ignore all':
				DB::query("delete from user_pending where 1=1");
		}
	};
	...
	<div class="col-sm-9">
		...
		<?php elseif ($cur_tab === 'blogs'): ?>
			<div style="overflow:hidden">
				<div style="width: 50%;display:inline-block; float: left;padding:10px;">
					<h4>Recent Blogs</h4>
					<?php
						echoLongTable(array('id','title'), 'blogs', "1=1", 'order by id desc',
							<<<EOD
								<tr style="floating:right">
									<th width=15%>id</th>
...
EOD;
				...
				<div style="width: 50%;display:inline-block; float: left;padding:10px;">
					...
					<?php
						echoLongTable(array('id','name'), 'contests', "1=1", "order by id desc",
							<<<EOD
								<tr style="floating:right">
									<th width=15%>id</th>
									<th width=85%>title</th>
